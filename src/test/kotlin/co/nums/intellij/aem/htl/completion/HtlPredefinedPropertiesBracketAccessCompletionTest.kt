...
class HtlPredefinedPropertiesBracketAccessCompletionTest : HtlCompletionTestBase() {
    ...
    fun testPropertyInLogicalExpression() =
            checkByTextContainsAll("<div>$DOLLAR{properties[someOtherValue || '<caret>']}</div>", *allPredefinedProperties)
