...
public class HtlTextFragmentImpl extends ASTWrapperPsiElement implements HtlTextFragment {

  public HtlTextFragmentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HtlVisitor visitor) {
    visitor.visitTextFragment(this);
  }
